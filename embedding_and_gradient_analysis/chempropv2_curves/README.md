...
- `recovery_40k_1pct_5pct.png` — 40k, 1% vs 5% batch
- `recovery_40k_batchsweep.png` — final recovery@1% vs batch size
- `recovery_1p3M.png` — 1.29M recovery curves (0.25 / 0.5 / 1 / 2% batch)
- `recovery_summary.csv`, `recovery_summary_table.png`
